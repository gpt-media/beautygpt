...
faqs:
  ...
  - q: "Does popping a pimple raise the risk of dark marks?"
    a: "Yes. Popping raises the scar and dark-mark risk regardless of where you live. The dark marks (post-inflammatory hyperpigmentation) linger and can deepen further with sun exposure. Wearing a patch instead of popping, then using sunscreen daily, is the simplest way to lower that risk. This is educational, not medical advice. See a doctor for severe, persistent, or painful cystic acne."
---
...
1. **Cleanse and dry the area.** Patches stick best, and matter most, on clean, dry skin. If you're in a humid climate, making sure skin is fully dry before applying is doubly important or the patch lifts.
...
### Where to buy patches and what to expect on price

You don't need anything fancy to beat popping; any honest hydrocolloid patch will do. Widely available options include **COSRX Acne Pimple Master** (a reliable all-rounder), **Nexcare Acne Dressing** (a gentle, unmedicated option), and **Hero Mighty Patch** (a popular flat hydrocolloid patch). You'll find these at major pharmacies and drugstores, as well as online through Amazon, iHerb, and Sephora, among others. Prices vary by region; check current listings for per-patch pricing, since a cheap-looking pack with few patches can cost more per patch than a larger one.

For a fuller breakdown of how different patches compare, see our guide to the [best acne patches](/articles/best-acne-patches-2026/).
