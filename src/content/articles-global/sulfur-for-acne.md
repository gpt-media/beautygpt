...
description: "Sulfur absorbs excess oil, mildly unclogs pores, and calms inflamed pustules while remaining gentler than benzoyl peroxide on sensitive skin. It works slowly and smells noticeable, making it best suited to surface whiteheads and mild-to-moderate breakouts rather than deep cystic acne."
publishDate: 2026-05-10
updatedDate: 2026-06-09
category: "Acne"
faqs:
  - q: "Does sulfur actually work for acne?"
    a: "Yes, for the right type. Sulfur absorbs excess oil, has mild keratolytic (skin-shedding) action that loosens clogged pores, and reduces the bacteria and inflammation behind pustules. It works slowly and gently, so it suits surface whiteheads and mild-to-moderate breakouts rather than deep cystic acne."
  - q: "Is sulfur stronger or weaker than benzoyl peroxide?"
    a: "Generally milder. Benzoyl peroxide kills acne bacteria more aggressively and is the more proven all-rounder, but it can be drying and irritating. Sulfur is a gentler option for sensitive or reactive skin, or for people who can't tolerate benzoyl peroxide, though it usually works more slowly."
  - q: "Why does sulfur acne treatment smell?"
    a: "Sulfur compounds naturally have a faint rotten-egg or struck-match odour. Modern formulas mask it reasonably well, and most people only notice it up close or right after applying. It fades as the product dries. If the smell bothers you, use it as an overnight spot treatment rather than an all-over mask."
  - q: "Can I use sulfur with salicylic acid or niacinamide?"
    a: "Usually yes. Sulfur layers fine with niacinamide and gentle hydrators. Combining it with salicylic acid, benzoyl peroxide, or retinoids in the same routine can over-dry skin, so introduce one active at a time and space them out (for example, salicylic acid in the morning, sulfur at night) and watch for irritation."
  - q: "Where can I buy sulfur acne products?"
    a: "Medicated sulfur soaps and ointments are widely available at pharmacies and drugstores. Imported sulfur spot treatments and masks (including Korean and US labels) are broadly stocked at online retailers such as Amazon, iHerb, Sephora and Ulta. Prices vary by region; check current listings for up-to-date figures."
  - q: "When should I see a doctor instead of using sulfur?"
...
## How sulfur works on a pimple

Sulfur tackles acne on three fronts at once, which is part of why it's been around so long.

**It soaks up oil.** Sulfur is mattifying. On oily and combination skin, excess sebum feeds breakouts and leaves skin shiny. Sulfur helps blot it.
...
The catch is speed. Sulfur is a slow, steady worker. You won't see a pimple vanish overnight the way marketing sometimes implies. Give it consistent use over a couple of weeks before judging it.

## Sulfur vs benzoyl peroxide vs salicylic acid

Most people choosing an over-the-counter spot treatment are really deciding between these three. They overlap, but each has a clear lane.

| Ingredient | Best at | Strength | Irritation risk | Smell |
|---|---|---|---|---|
| **Sulfur** | Pustules, oil control, sensitive skin | Mild | Low | Noticeable (sulfur/egg) |
...
People with sensitive skin, rosacea-prone skin, or those who flush and peel from strong actives often get stuck. The standard advice points them at benzoyl peroxide or retinoids, which can be too much. Sulfur is one of the few acne actives that's genuinely low-irritation. It's also commonly paired with sodium sulfacetamide in some treatments your doctor might suggest. On its own, over the counter, it's a sensible thing to try before assuming you've run out of options.

## The downsides, stated plainly

Sulfur has two honest drawbacks, and pretending otherwise would be doing you a disservice.
...
## Using sulfur the right way

In warm, humid climates oil control matters, but so does not stripping your skin into a tight, irritated mess. The same principle applies everywhere: a simple, targeted approach works best.
...
- **Wear sunscreen in the day.** Any acne active can leave skin a little more reactive to UV exposure.
- **Don't stack everything at once.** If you're already using salicylic acid, benzoyl peroxide, or a retinoid, add sulfur on alternate nights and watch how your skin responds. A full breakdown of how to layer actives sits in our guide to [how to treat acne effectively](/articles/how-to-treat-acne/).

### What to look for

Sulfur shows up in a few forms, at very different price points:

- **Medicated sulfur soaps and bar cleansers.** The cheapest, most widely available form. Found at pharmacies and drugstores globally. Useful for oily, body, or back acne; less precise for facial spots.
- **Sulfur ointments and spot pastes.** Older pharmacy staples and imported labels. The well-known overnight drying lotions that settle into a bottle (a clear liquid over a pink sediment) use sulfur as a key ingredient and are popular for zapping individual pustules.
...
Many sulfur treatments are available at pharmacies and major drugstores worldwide, as well as online at Amazon, iHerb, Sephora and Ulta. Prices vary by region; check current listings for up-to-date figures. Stick to listings with clear ingredient lists and a stated sulfur concentration, and follow the product label for how often to use it rather than improvising. Typical over-the-counter sulfur products fall in a low single-digit to around 10% concentration range, but formulas vary, so the label is your source of truth.
