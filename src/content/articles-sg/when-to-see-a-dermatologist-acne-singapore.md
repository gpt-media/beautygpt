---
title: "When to See a Dermatologist for Acne (Singapore)"
...
faqs:
  ...
  - q: "Do I need a GP referral to see a dermatologist in Singapore?"
    a: "In private practice you can usually book a dermatologist directly, no referral needed. In the public system you typically start at a polyclinic, where a GP treats you first and refers you to a restructured hospital's dermatology clinic if needed. The subsidised public route is cheaper but waiting lists can be long."
  ...
  - q: "How much does a dermatologist appointment for acne cost in Singapore?"
    a: "A private dermatologist consultation is roughly $120-$250 for the first visit, with medication and any procedures on top. Check with the specific clinic. The public system is subsidised and cheaper, but you'll usually go through a polyclinic GP first and wait longer for a specialist slot. A community pharmacist costs nothing and is a sensible first stop."
...
If you're not sure your routine is even giving treatment a fair chance, that's the first thing to fix, not the specialist booking. We walk through what actually works, and in what order, in [how to treat acne in Singapore](/sg/articles/how-to-treat-acne-singapore/) and in the step-by-step [acne skincare routine guide](/sg/articles/how-to-build-acne-skincare-routine-singapore/). Three months of *doing the right things* beats three months of switching products every fortnight.
