...
faqs:
  ...
  - q: "How do I find the official store for a brand on Shopee or Lazada?"
    a: "Look for the platform's official-store or verified badge (Shopee Mall, LazMall), check that the shop name matches the brand exactly, and read recent reviews for complaints about authenticity. For brands sold in pharmacies, buying from Watsons or Guardian in-store removes the guesswork entirely."
