...
If you want the ingredients that genuinely move the needle on acne, and the order to layer them in, we cover that in [how to treat acne in Singapore: the ingredients and routine that actually work](/sg/articles/how-to-treat-acne-singapore/). Tea tree, at best, is a minor supporting player in that line-up.
