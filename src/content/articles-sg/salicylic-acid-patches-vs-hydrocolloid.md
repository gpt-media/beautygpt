...
description: "A plain hydrocolloid patch just absorbs fluid and protects the spot. A salicylic acid (medicated) patch adds an exfoliating, anti-inflammatory active. The active earns its place on oily, congested or early spots; on a clean surfaced whitehead it does little extra and can irritate."
...
faqs:
  ...
  - q: "Which is better for sensitive skin, plain or medicated patches?"
    a: "Plain, unmedicated hydrocolloid is the safer first choice for sensitive skin, because there is no active to provoke a reaction under occlusion. Nexcare Acne Dressing is a common gentle option. Try a medicated patch only once you know plain ones sit fine, and patch-test on one spot first."
...
## What this looks like on Singapore shelves
...
- **Nexcare Acne Dressing**, a genuinely plain, unmedicated hydrocolloid, budget-friendly at approximately $8, and the easy first pick if you want zero actives. Widely stocked at Watsons and Guardian.
- **COSRX Acne Pimple Master**, the reliable all-rounder at approximately $10–13 for 24. Effectively a plain hydrocolloid in practice; people reach for it because it simply works and is everywhere.
- **Hero Mighty Patch**, the well-known premium import with a cult following, a thin, reliable plain hydrocolloid at approximately $13–18; you pay more for it than the local-shelf options, and it is easy to find on Amazon.sg, iHerb and Lazada.
- **Watsons Acne Patch**, a plain hydrocolloid and the convenience pick, cheap at approximately $5–8 and stocked in every Watsons store islandwide, so it is the easiest one to grab when you need a patch tonight.
- **Some By Mi Clear Spot Patch**, a breathable K-beauty hydrocolloid at approximately $10–15.

**Carries actives (the medicated end):**

- **OXY Acne Patch**, a medicated/antibacterial option at approximately $6–7 for those who specifically want an active element.
- **STIK Original Dot**, a hydrocolloid that *also* carries actives (salicylic acid, niacinamide and tea tree) in mixed sizes at approximately $5 for 15. It is one of the cheaper ways to get an actives-bearing patch, which matters if you break out often, though, as with any medicated patch, watch how oily-versus-sensitive your skin runs.
