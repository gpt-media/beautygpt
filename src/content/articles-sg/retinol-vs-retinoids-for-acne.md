...
description: "Retinol and retinoids are the same family. Retinol is the weaker, over-the-counter version; retinoids like adapalene and tretinoin are stronger and treat acne at the root by speeding cell turnover and unclogging pores. Most acne-prone beginners in Singapore are better off starting with adapalene."
...
| Ingredient | Type | Strength | Needs prescription in SG? | Best known for |
|---|---|---|---|---|
...
That last point matters a lot for skin in Singapore, where post-acne marks (the brown or dark patches left after a spot heals) are often more stubborn and more visible than the spot itself.

Notice what this means: a retinoid is a *preventive* treatment, not a spot zapper. It works by stopping the next month's breakouts, not by shrinking tonight's pimple. That is why you have to give it weeks, and why it is the backbone of a real acne routine rather than a quick fix. We cover how it fits alongside cleansers, actives and moisturiser in our guide to [building an acne skincare routine in Singapore](/sg/articles/how-to-build-acne-skincare-routine-singapore/).

Benzoyl peroxide and salicylic acid attack acne from other angles. Benzoyl peroxide kills acne-causing bacteria, while salicylic acid is a BHA that exfoliates inside the pore. Retinoids are the third pillar, working on cell turnover. They are not rivals; the strongest routines often combine them, which we lay out in [how to treat acne in Singapore](/sg/articles/how-to-treat-acne-singapore/).
...
For an adapalene-specific walkthrough (strengths, how to layer it, and what to expect week by week), see our dedicated guide to [adapalene (Differin) in Singapore](/sg/articles/adapalene-singapore/).

## Sun sensitivity: a Singapore-specific warning

Retinoids make your skin more sensitive to UV, and they thin the very top dead-cell layer while they work. Under the strong, year-round equatorial sun in Singapore, that has two consequences you cannot ignore:
...
- **New to actives, mild to moderate acne:** start with **adapalene 0.1%** (OTC in Singapore), slow-start schedule, nightly sunscreen. This is the default recommendation for most people reading this.
...
You will find this family across Watsons and Guardian in-store, and online on Shopee, Lazada, Amazon.sg and iHerb:

- **Adapalene (Differin 0.1% gel)**: the standout OTC acne retinoid, roughly $25 to $40 depending on size and seller (approximate, check the current listing).
- **Retinol serums**: a wide range, from affordable drugstore options around $15 to $30 up to premium brands well over $80. Some By Mi and other Korean labels are widely stocked; many Western retinol serums sell through Watsons and online too.
