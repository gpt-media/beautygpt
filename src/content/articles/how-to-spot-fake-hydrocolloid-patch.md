...
faqs:
  - q: "How can I tell if a pimple patch is fake?"
    a: "Look for three things: a printed batch/lot number and a real expiry date on the packaging, a price that isn't suspiciously far below the official store, and a verified official seller. Genuine hydrocolloid also turns visibly white as it absorbs fluid from a surfaced pimple. A counterfeit or non-hydrocolloid sticker often just sits there doing nothing."
  ...
  - q: "Do real hydrocolloid patches always turn white?"
    a: "Over a surfaced pimple with fluid to absorb, yes: genuine hydrocolloid swells and turns opaque white where it has drawn out the gunk. If there's nothing on the surface yet (an early under-skin bump), even a real patch won't turn white, because there's nothing to absorb. So use the white test only on a pimple that has actually surfaced."
  - q: "What should I do if I bought a fake acne patch?"
    a: "Stop using it, especially if your skin reacts. Report the listing to the platform and request a refund, and leave an honest review so other buyers are warned. If you developed irritation, treat it gently and see a doctor if it's painful, spreading, or not settling. This is educational, not medical advice."
---
...
Be precise about this one, because "cheap" alone is not evidence of a fake. Genuine budget options are *legitimately* cheaper than imports. A value hydrocolloid dot can sit around ~RM7–10 for 15 patches, and a budget pick like the Watsons Acne Patch runs roughly ~RM10–15 a pack on the shelf of every Watsons store nationwide (both approximate, so check the current listing), and be completely real. A low price like that isn't a red flag; it's just a cheaper, easier-to-find product. What matters is the price **relative to the official listing for the same product**. A "COSRX" pack well under its normal ~RM10–20 (approximate, so always confirm against the official store), sold by an unknown seller, is the warning sign, not a low price in absolute terms.
...
Where you buy matters as much as what the box says. The risk is highest with sellers who have **no official-store badge, a brand-new account, very few or oddly generic reviews, or a shop name that's a near-miss of the real brand** (extra letters, a different spelling). On Shopee and TikTok Shop, the platforms label verified and official stores, so use that. We go deeper on safe sourcing and current pricing in our [Malaysia price and where-to-buy guide](/my/articles/where-to-buy-acne-patches-malaysia-price-guide/).
