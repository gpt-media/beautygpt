...
| STIK Original Dot | Value brand | Hydrocolloid | Multi-size, value pick | ~RM7–10 / 15 |

All prices are approximate, so always check the current listing. A few honest observations:
...
- **The Watsons Acne Patch is one of the cheapest, and it is everywhere.** It is a budget hydrocolloid patch you can grab in any Watsons store nationwide, which makes it the easy convenience pick when you just need a patch today.
- **Nexcare, also Western, is one of the cheapest.** Region tells you almost nothing about price.
- **The value pick often undercuts both.** STIK Original Dot lands at an approximate RM7–10 for 15 mixed-size patches with salicylic acid, niacinamide and tea tree, which matters if you break out often and are buying patches regularly.

On availability: Watsons and Guardian stock a fairly narrow in-store selection (you will reliably find COSRX, Oxy and Nexcare). The widest range of Korean brands lives online (Shopee, TikTok Shop and Lazada), alongside value options like STIK. That is also where the best prices tend to be.
