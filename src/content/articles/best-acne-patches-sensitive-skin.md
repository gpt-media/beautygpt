...
faqs:
  ...
  - q: "How do I patch-test an acne patch?"
    a: "Apply one patch to a small, less visible area — inner forearm or along the jaw — on clean dry skin and leave it for a few hours or overnight. Check for redness, itching, stinging or a rash before you ever put one on a fresh breakout on your face. Do this with any new patch, especially a medicated one."
  - q: "Can pimple patches cause irritation or make sensitive skin worse?"
    a: "They can. The two usual causes are an active ingredient your skin reacts to, or removing the patch too roughly and tearing slightly damp skin. Occlusion can also briefly trap heat and sweat in Malaysia's humidity. Choosing unmedicated patches, applying to fully dry skin and peeling gently almost always solves it."
...
2. **Mechanical irritation** — peeling the patch off too hard and tearing slightly damp, fragile skin.
...
- **Applying to damp skin or over thick serum.** Trapped moisture under the patch softens skin and makes irritation and rough removal more likely. Dry skin first, always — doubly true in Malaysia's heat and humidity, where a patch can also briefly trap sweat.
...
All approximate — check the current listing, and compare the **per-patch** price, not the per-pack price.
