...
faqs:
  ...
  - q: "Should teens use medicated or unmedicated acne patches?"
    a: "Start unmedicated. A plain hydrocolloid patch handles a surfaced whitehead by absorbing fluid and protecting it — no drug needed. Reach for a medicated patch (salicylic acid or benzoyl peroxide) only for stubborn spots, and not every night, since teen skin can over-dry. If breakouts are widespread rather than the odd spot, patches treat symptoms, not the cause — that's a conversation for a doctor."
  - q: "Where can teens buy acne patches in Malaysia?"
    a: "Watsons and Guardian stock COSRX, Oxy, and Nexcare in-store, which is easy if a parent is shopping nearby. Shopee, TikTok Shop, and Lazada carry the widest range at the best prices, including local options like STIK. Buy from official stores and check reviews before ordering."
---
...
All of these are sold in Malaysia and suit a teenager for the right situation. Prices are approximate — always check the current listing.
...
- **Shopee / TikTok Shop / Lazada** — the widest range and best prices, including local options like STIK and the full spread of Korean brands. Buy from the brand's **official store**, read recent reviews, and check the expiry isn't close.
