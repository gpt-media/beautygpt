...
- **It interrupts pigment production.** This is the part that makes it special for Malaysian skin. After a spot heals, the inflammation it caused can leave a dark mark — post-inflammatory hyperpigmentation, or PIH. Azelaic acid inhibits tyrosinase, the enzyme that drives melanin production, specifically in overactive cells. In practice that means it fades existing marks and helps stop new ones forming, without lightening your normal skin tone.
...
- **Shopee, Lazada, and TikTok Shop:** the widest range and frequent promo pricing. Buy only from official brand stores or authorised sellers — actives are commonly faked, and a counterfeit at the wrong concentration is worse than useless.
