...
faqs:
  ...
  - q: "Where can I buy acne patches in Malaysia?"
    a: "Watsons and Guardian stock most mass brands (COSRX, Oxy, Nexcare) in-store. Shopee and TikTok Shop carry the widest range, including Korean brands and value options like STIK, usually at the lowest prices. Check the seller's reviews and that it's an official store."
...
**Value.** You don't have to pay import prices for good hydrocolloid. Value options like **STIK Original Dot** (approximately RM7–10 for 15 mixed-size patches, with salicylic acid, niacinamide and tea tree) do the same core job as the pricier imported patches, which matters if you break out often.
