...
That's the short answer. The reason it splits so cleanly along patch *thickness* (and how to apply makeup over a patch so neither one falls apart by lunchtime in Malaysian heat) is worth a few minutes.
